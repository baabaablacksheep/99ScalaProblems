...
//  print("P01 Result =>    ")
//  P01.getResult(myIntList)
//  print("P02 Result =>    ")
//  P02.getResult(myIntList)
//  print("P03 Result =>    ")
//  P03.getResult(myIntList,5)
//  print("P04 Result =>    ")
//  P04.getResult(myIntList)
//  print("P05 Result =>    ")
//  P05.getResult(myIntList)
//  print("P06 Result =>    ")
//  P06.getResult(myIntList)
//  print("P06 Result =>    ")
//  P06.getResult(palList)
//  print("P07 Result =>    ")
//  P07.getResult(multiStructList)
//  print("P08 Result =>    ")
//  P08.getResult(myIntList)
//  print("P09 Result =>    ")
//  P09.getResult(myIntList)
//  print("P10 Result =>    ")
//  P10.getResult(myList)
//  print("P11 Result =>    ")
//  P11.encodeModified2(myIntList)
//  print("P12 Result =>    ")
//  P12.getResult(lengthEncodedList)
//  print("P13 Result =>    ")
//  P13.getResult(myCharList)
//  print("P14 Result =>    ")
